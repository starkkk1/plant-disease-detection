"""
Training script for MobileNetV3 Small model.
...
def setup_logger(log_file):
    logger = logging.getLogger('mobilenet_v3_small')
...
def main():
    ...
    config_path = os.path.join(base_dir, 'configs', 'mobilenet_v3_small.yaml')
    ...
    try:
        ...
        logger.warning(f"Failed to load via timm with name {model_name}. Attempting fallback name mobilenetv3_small_100")
