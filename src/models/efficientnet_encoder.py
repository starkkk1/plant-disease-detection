...
class EfficientNetEncoder:
    def __init__(self, 
        ...
        print(f"Loading EfficientNetEncoder on {self.device}...")
        
        # EfficientNet-B0 default resolution is 224x224, same as MobileNet
        ...
        # Thay thế lớp classifier cuối cùng bằng Identity để lấy vector đặc trưng (1280-d cho efficientnet_b0)
